<?php
/**
 * @version    SVN $Id: default_media_details.php 882 2013-01-07 11:53:44Z dhorsfall $
		...
		<div class="item column-<?php echo $rowcount;?><?php echo ($item->published != '1' ? ' system-unpublished' : false); ?> span<?php echo round((12/$this->columns));?>"> 
			...
			<div class="system-unpublished">
				...
				<div class="thumbnail media-item">
					...
					<?php endif; ?>
					<a href="<?php echo JRoute::_(hwdMediaShareHelperRoute::getMediaItemRoute($item->slug)); ?>"> <img src="<?php echo JRoute::_(hwdMediaShareDownloads::thumbnail($item)); ?>" border="0" alt="<?php echo $this->escape(JHtmlString::truncate($item->title, $this->params->get('global_list_title_truncate'))); ?>" style="max-width:100%;" /> </a>
					<?php endif; ?>
				</div>
