...
<!--tablas css-->
<!--
<link rel="styesheet" type="text/css" href="<?php echo JURI::Root()?>/css/demo_page.css" />
<link rel="stylesheet" type="text/css" href="<?php echo JURI::Root()?>/css/tablas.css">
<link rel="styesheet" type="text/css" href="http:<?php echo JURI::Root()?>/css/demo_table.css" />
-->
<!-- scripts-->
